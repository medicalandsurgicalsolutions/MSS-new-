    ...
    if (location.pathname === "/products") {
      ...
      exportDataFromAPI("products", (products) => 
        ...
        .map((product) => ({
          ...
          link: `https://medicalsurgicalsolutions.com/product/${product?.slug}`,
          ...
          categories: product?.categories?.map((cat) => cat?.name?.en).join(", "),
          metatitle: product?.metatitle?.en,
          ...
          productRefrenceNo: product?.productRefrenceNo,
          slug: product?.slug,
          sku: product?.sku,
          stock: product?.stock,
          barcode: product?.barcode,
          isCodAvaialble: product?.isCodAvaialble,
