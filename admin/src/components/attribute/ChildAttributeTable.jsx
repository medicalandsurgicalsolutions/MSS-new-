...
import ToggleStatusButton from "@/components/table/ToggleStatusButton";
...
const ChildAttributeTable = ({
  ...
  const { can, editButtonCLick, deleteButtonCLick } = usePermission("attribute", handleUpdate, handleModalOpen);
        ...
        {childAttributes?.map((attribute, index) => (
          <TableRow key={index + 1}>
            ...
            <TableCell className="text-center">
              <ToggleStatusButton id={attribute._id} status={attribute.status} canToggleStatus={can.edit}/>
            </TableCell>
