...
const LanguageTable = ({ languages, isCheck, setIsCheck }) => {
  ...
  const { can, editButtonCLick, deleteButtonCLick } = usePermission("language", handleUpdate, handleModalOpen);
        ...
        {languages?.map((language, i) => (
          <TableRow key={language._id}>
            ...
            <TableCell className="text-center">
              <ToggleStatusButton id={language._id} status={language.status} canToggleStatus={can.edit}/>
            </TableCell>
