        ...
        <div className="col-span-12 md:col-span-12 lg:col-span-12 mt-5">
          ...
          <div className="xl:px-10 flex-grow scrollbar-hide w-full max-h-full">
            ...
            >
              ...
              <div className="sm:col-span-4">
                <ReactTagInput
                  placeholder="Enter the discount offer and click inter"
                  tags={couponList || []}
              ...
              <div className="grid md:grid-cols-5 sm:grid-cols-6 gap-3 md:gap-5 xl:gap-6 lg:gap-6 md:mb-6 mb-3 relative">
                ...
                <div className="sm:col-span-4">
                  <InputAreaTwo
                    ...
                    type="text"
                    placeholder="https://medicalsurgicalsolutions.com/search?category=fruits-vegetable&_id=632aca2b4d87ff2494210be8"
                  />
