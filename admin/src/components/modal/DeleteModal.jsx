  ...
  const handleDelete = async () => {
    try {
      ...
      if (location.pathname === "/clients") {
        if (ids) {
          const res = await ClientServices.deleteManyClient({
            ids: ids,
          });
          setIsUpdate(true);
          notifySuccess(res.message);
      ...
      if (location.pathname === "/award") {
        if (ids) {
          const res = await AwardServices.deleteManyAward({
            ids: ids,
          });
          setIsUpdate(true);
          notifySuccess(res.message);
          ...
          const res = await AwardServices.deleteAward(id);
          setIsUpdate(true);
          notifySuccess(res.message);
          setServiceId();
          closeModal();
      ...
      if (location.pathname === "/blogs") {
        if (ids) {
          const res = await BlogServices.deleteManyBlog({
            ids: ids,
          });
          setIsUpdate(true);
          notifySuccess(res.message);
      ...
      if (location.pathname === "/partners") {
        if (ids) {
          const res = await PartnerServices.deleteManyPartner({
            ids: ids,
          });
          setIsUpdate(true);
          notifySuccess(res.message);
      ...
      if (location.pathname === "/pincode") {
        if (ids) {
        
          const res = await PincodeService.deleteMany({
            ids: ids,
          });
          setIsUpdate(true);
          notifySuccess(res.message);
          ...
          const res = await PincodeService.delete(id);
          setIsUpdate(true);
          notifySuccess(res.message);
          setServiceId();
          closeModal();
