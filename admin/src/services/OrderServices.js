...
const OrderServices = {
  ...
  updateOrderTrackLink: async (id, body, headers) => {
    return requests.put(`/orders/track/${id}`, body, headers);
  },

  updateOrderDeliveryPartner: async (id, body, headers) => {
    return requests.put(`/orders/deliverypartner/${id}`, body, headers);
  },

  updateOrderTrackNo: async (id, body, headers) => {
    return requests.put(`/orders/trackno/${id}`, body, headers);
  },
