...
import PincodeTable from "@/components/Pincode/PincodeTable";
import PincodeService from "@/services/PincodeService";
import PincodeDrawer from "@/components/drawer/PincodeDrawer";
...
const Pincode = () => {
  ...
  const { data, loading, error } = useAsync(PincodeService.getAll);
  ...
  const handleSelectAll = () => {
      ...
      setIsCheck(data?.pincodes?.map((li) => li._id));
      if (isCheckAll) {
          setIsCheck([]);
      }        
  };
                            ...
                            >
                                <div className="flex-grow-0 md:flex-grow lg:flex-grow xl:flex-grow">
                                    <Input
                                        ref={brandRef}
                                        type="search"
                                        placeholder={t("Search by pincode")}
                                    />
                                </div>
                    ...
                    <TableContainer className="mb-8">
                        <Table>
                            ...
                            <tr>
                                ...
                                <TableCell className="text-center">{t("Pincode")}</TableCell>
                                <TableCell className="text-center">{t("Branch")}</TableCell>
