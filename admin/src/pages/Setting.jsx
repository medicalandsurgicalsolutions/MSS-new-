...
const Setting = () => {
  ...
  const { can } = usePermission("settings");
                  ...
                  <div className="grid md:grid-cols-5 items-center sm:grid-cols-12 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                    ...
                    <div className="sm:col-span-3">
                      <InputAreaTwo
                        required={true}
                        register={register}
                        label={t("MaxRefundDays")}
                        name="max_refund_days"
                        type="text"
                        placeholder={t("MaxRefundDays")}
                      />
                      <Error errorName={errors.max_refund_days} />
                    </div>
                  </div>
                  <div className="grid md:grid-cols-5 items-center sm:grid-cols-12 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                    <label className="block text-sm font-semibold text-gray-600 dark:text-gray-400 mb-1 sm:col-span-2">
                    ...
                    <div className="sm:col-span-3">
                      <InputAreaTwo
                        required={true}
                        register={register}
                        label={t("MinCouponAmount")}
                        name="min_coupon_amount"
                        type="number"
                        placeholder={t("MinCouponAmount")}
                      />
                      <Error errorName={errors.min_coupon_amount} />
                    </div>
                  </div>
                  <div className="grid md:grid-cols-5 items-center sm:grid-cols-12 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                    <label className="block text-sm font-semibold text-gray-600 dark:text-gray-400 mb-1 sm:col-span-2">
                    ...
                    <div className="sm:col-span-3">
                      ...
                      />
                      <Error errorName={errors.max_coupon_discount_percent} />
                    </div>
                  </div>
                  <div className="grid md:grid-cols-5 items-center sm:grid-cols-12 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                    <label className="block text-sm font-semibold text-gray-600 dark:text-gray-400 mb-1 sm:col-span-2">
                    ...
                    <div className="sm:col-span-3">
                      <InputAreaTwo
                        ...
                        name="max_coupon_discount_amount"
                        type="number"
                        placeholder={t("DiscountAmount")}
                      />
                      <Error errorName={errors.max_coupon_discount_amount} />
                    </div>
                  </div>
                  <div className="grid md:grid-cols-5 items-center sm:grid-cols-12 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                    <label className="block text-sm font-semibold text-gray-600 dark:text-gray-400 mb-1 sm:col-span-2">
