...
const MedicinePage = () => {
  ...
  return (
    <Layout
      title="Upload Prescription | Medical & Surgical Solutions"
      description="Upload your prescription easily and get medicines delivered with Medical & Surgical Solutions."
    >
      <PageHeader
        headerBg={storeCustomizationSetting?.contact_us?.header_bg}
        title={showingTranslateValue("Upload Your Prescription")}
      />
...
// ✅ Disable SSR like other pages (safe for client hooks)
