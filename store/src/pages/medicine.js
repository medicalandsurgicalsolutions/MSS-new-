...
export default function PrescriptionPage() {
  ...
  const handleSavePrescription = (fileName: string) => {
                  ...
                  <div className="absolute top-12 left-8">
                    <div className="flex items-center gap-2">
                      <div className="w-0 h-12 border-l-2 border-red-500 border-b-2 border-dashed relative">
                        <span className="absolute -top-6 -left-20 text-xs font-semibold text-red-500 whitespace-nowrap">
                          Doctor&apos;s details
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="absolute top-12 right-8">
                    <div className="flex items-center gap-2">
                      <div className="w-0 h-12 border-r-2 border-red-500 border-b-2 border-dashed relative">
                        <span className="absolute -top-6 right-0 text-xs font-semibold text-red-500 whitespace-nowrap">
                          Patient&apos;s details
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="absolute bottom-12 left-8">
                    <div className="flex items-center gap-2">
                      <div className="w-0 h-12 border-l-2 border-red-500 border-t-2 border-dashed relative">
                        <span className="absolute top-12 -left-20 text-xs font-semibold text-red-500 whitespace-nowrap">
                          Medicine details
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="absolute bottom-12 right-8">
                    <div className="flex items-center gap-2">
                      <div className="w-0 h-12 border-r-2 border-red-500 border-t-2 border-dashed relative">
                        <span className="absolute top-12 right-0 text-xs font-semibold text-red-500 whitespace-nowrap">
                          Doctor&apos;s sign + stamp
                        </span>
                      </div>
                    </div>
