...
const Home = ({
  ...
  DisProduct?.length > 0 && (
    <div
      id="discount"
      className="bg-gray-50 py-10 lg:py-16 mx-auto max-w-screen-2xl px-4 sm:px-6 md:px-8 lg:px-10"
    >
      {/* Heading Section */}
      <div className="mb-8 lg:mb-10 flex justify-center text-center">
        <div className="w-full md:w-4/5 lg:w-2/5">
          <h2 className="text-lg sm:text-xl lg:text-2xl mb-2 font-semibold">
            <CMSkeleton
              count={1}
              height={30}
              loading={loading}
          ...
          <p className="text-sm sm:text-base font-sans text-gray-600 leading-6 px-2 sm:px-0">
            <CMSkeleton
              count={5}
              height={20}
              loading={loading}
