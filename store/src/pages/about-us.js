...
<div className="grid lg:grid-cols-2 gap-8 items-stretch">
  {/* Stats */}
  <div className="bg-white rounded-xl flex items-center justify-center p-4 sm:p-6 lg:p-8">
    <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 gap-4 text-center w-full">
      {[
