              ...
              <div className="border p-5 lg:px-8 lg:py-8 rounded-lg bg-white order-1 sm:order-2">
                ...
                <div className="overflow-y-scroll flex-grow scrollbar-hide w-full max-h-64 bg-gray-50 block">
                  {items.map((item) => (
                    <div
                      key={item.id}
                      className="flex flex-col border-b py-3 space-y-2"
                    >
                      ...
                      {/* ✅ Prescription only for medicine */}
                      ...
                      <div className="flex flex-col sm:flex-row items-start justify-end">
                        ...
                        {isCouponAvailable ? (
                          <button
                            ...
                            type="submit"
                            className="md:text-sm leading-4 inline-flex items-center cursor-pointer transition ease-in-out duration-300 font-semibold text-center justify-center border border-gray-200 rounded-md placeholder-white focus-visible:outline-none focus:outline-none px-5 md:px-6 lg:px-8 py-3 md:py-3.5 lg:py-3 mt-3 sm:mt-0 sm:ml-2 text-sm text-gray-700 bg-gray-50 hover:border-gray-300 hover:text-gray-800 hover:bg-gray-100 focus:ring-0 focus:outline-none focus:bg-gray-100"
                ...
                <div className="border-t py-4 mt-4 flex justify-between">
                ...
                <div className="flex justify-between border-t font-semibold text-base py-4">
