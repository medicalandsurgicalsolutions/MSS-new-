  ...
  return (
    <>
      <div className="hidden lg:block xl:block bg-gray-100 border-b text-sm text-black">
        {/* ✅ Added flex-nowrap + overflow-x-auto to prevent wrapping */}
        <div className="max-w-screen-2xl mx-auto px-6 sm:px-8 lg:px-10 flex justify-between items-center flex-nowrap overflow-x-auto scrollbar-hide">
          <div>
            <Link
